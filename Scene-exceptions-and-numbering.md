...
So when you have a show that requires a manual scene exception please submit a Pull Request to one of the 2 scene exception lists ([TVDB](https://github.com/SickChill/sick-rage.github.io/blob/master/sb_tvdb_scene_exceptions/exceptions.txt) or TVRage). This also helps other users that experience this problem.
...
Sometimes release groups and uploaders use different episode numbers then an indexer like TheTVDB or TVRage does. When that happens SickChill can have problems downloading the correct episode.
