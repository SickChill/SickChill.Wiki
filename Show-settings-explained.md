...
[ [Add Show button] ](https://github.com/SickChill/SickChill/wiki/Show-settings-explained#add-show-button) [ [Shows overview and buttons explained] ](https://github.com/SickChill/SickChill/wiki/Show-settings-explained#shows-overview-and-buttons-explained) [ [Shows Edit Button] ](https://github.com/SickChill/SickChill/wiki/Show-settings-explained#shows-edit-button)   
...
* SickChill also has the ability to add existing shows. Unlike newly added shows a existing show has already a folder with the episodes and/or meta data present. 
...
3 `Remove`  
Lets you remove the show from SickChill. When pushed you will get an pop-up screen with the question to remove the show with or without he file/folder.  
4 `Re-Scan`  
